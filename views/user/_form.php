    ...
    <div class="row">
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-heading"><span class="glyphicon glyphicon-lock"></span> <?= Yii::t('app',
                        'Authentication') ?></div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading"><span class="glyphicon glyphicon-user"></span> <?= Yii::t('app',
                        'Profile') ?></div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <?= $form->field($model, 'has_car')
                                ->dropDownList(User::getHasCarOptions(), ['prompt' => '']) ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                <div class="panel-heading"><span class="glyphicon glyphicon-plus-sign"></span> <?= Yii::t('app',
                        'Additional') ?></div>
                <div class="panel-body">
                    <?= $form->field($model, 'hw_id')->textInput() ?>
                    <?= $form->field($model, 'dtFrom')
                        ->widget(DatePicker::className(), ['options' => ['class' => 'form-control']]) ?>
                    <?= $form->field($model, 'dtTo')
                        ->widget(DatePicker::className(), ['options' => ['class' => 'form-control']]) ?>
